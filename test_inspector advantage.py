...
START_HOR = 60
START_VER = 3000
DEAD_NODES = [616, 771, 1261, 1450, 1705, 1905, 1936, 1996, 2025, 3042, 3052, 3069, 3127, 3204, 3413, 3422, 3597, 3852, 4442, 4666, 4949, 5207, 5460, 5685]
...
sampler = DWaveSampler(solver='Advantage_system6.1', token=os.environ.get("dwave_token"))
